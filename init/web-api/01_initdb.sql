...
CREATE TABLE Equipment (
    id UUID PRIMARY KEY REFERENCES Item(id),
...
CREATE TABLE ChainElement (
    quest_id UUID REFERENCES Quest(id),
    quest_chain_id UUID REFERENCES QuestChain(id),
...
CREATE TABLE Effect (
    ...
    duration INTEGER,
    parent_id UUID REFERENCES Effect(id),
    child_id UUID REFERENCES Effect(id),
